        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10,),
              Text("Hình thức khóa học", style: GoogleFonts.nunitoSans(),),
              SizedBox(height: 10,),
              Obx(() => RoundedDropdownButton(
              ...
              SizedBox(height: 10,),
              Text("Số lượng học viên", style: GoogleFonts.nunitoSans(),),
              TextField(
                cursorColor: primaryColor,
                decoration: primaryTextFieldDecoration,
              ),
              SizedBox(height: 10,),
              Text("Giá tiền đề nghị (vnd)", style: GoogleFonts.nunitoSans(),),
              TextField(
                cursorColor: primaryColor,
                decoration: primaryTextFieldDecoration,
              ),
              SizedBox(height: 10,),
              Text("Địa điểm học", style: GoogleFonts.nunitoSans(),),
              TextField(
                cursorColor: primaryColor,
                decoration: primaryTextFieldDecoration,
              ),
              ...
              Row(
                children: [
                  Text("Thời gian", style: GoogleFonts.nunitoSans(),),
                  Expanded(
                    child: Padding(
              ...
              Obx(() => Wrap(
                children: controller.periods.map((element) {
                  ...
                  String startTime  = element.lessonTime.startTime.format(context);
                  String endTime = element.lessonTime.endTime.format(context);
                  return Padding(
              ...
              SizedBox(height: 10,),
              Text("Ngày bắt đầu - kết thúc dự kiến", style: GoogleFonts.nunitoSans(),),
              SizedBox(height: 10,),
              Row(
                children: [
                  Expanded(
              ...
              Visibility(
                ...
                child: Row(
                  children: [
                    Text("Thông tin học sinh", style: GoogleFonts.nunitoSans(),),
                    IconButton(
                      icon: Icon(Icons.add),
                      onPressed: () async {
              ...
              Center(
                child: ElevatedButton(
                  ...
                  child: Text('Mở lớp', style: GoogleFonts.nunitoSans(fontWeight: FontWeight.bold),),
                ),
              )
            ],
          ),
