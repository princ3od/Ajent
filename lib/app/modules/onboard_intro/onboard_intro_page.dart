...
class OnboardIntroPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
        child: IntroductionScreen(
          ...
          done: Text('Bắt đầu',style: GoogleFonts.nunitoSans(fontWeight: FontWeight.bold),),
          onDone: (){
  ...
  Widget buildImage(String path) => Center(child: Image.asset(path,width: 360));
  PageDecoration getPageDecoration() => PageDecoration(
    titleTextStyle: GoogleFonts.nunitoSans(fontWeight: FontWeight.bold,fontSize: 18),
    bodyTextStyle: GoogleFonts.nunitoSans(fontWeight: FontWeight.normal,fontSize: 14),
